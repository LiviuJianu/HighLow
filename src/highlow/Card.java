 ...
 * Card class for creating the cards in a Deck
 */
 ...
 * The card has a suit, which can be spades, hearts, diamonds, clubs or joker. A spade, heart,
 * diamond, or club has one of the 13 values: ace, 2, 3, 4, 5, 6, 7, 8, 9, 10, jack, queen or king. 
 * Note that "Ace" is considered to be the smallest value. A joker can also have an associated value;
 * this value can be anything and can be used to keep track of several different jokers.
 * @author Liviu Jianu
 */
public class Card {
     ...
     * the value must be in the range 1 through 13, with 1 representing Ace. 
    ...
    /**
     * Returns a String representation of the card's values.
